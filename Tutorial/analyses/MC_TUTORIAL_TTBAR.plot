# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*
LegendAlign=r
# END PLOT

# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*jet.?_[1234]_pT
XLabel=$p_\perp$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}p_\perp$ [pb GeV$^{-1}$]
LogX=1
# END PLOT

# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*jet_mult
...
# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*jets_mjj
...
# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*t_mass
...
# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*t_mass_W_cut
...
# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*_mass
XLabel=$m$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}m$ [pb GeV$^{-1}$]
# END PLOT

# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*_dR
XLabel=$\Delta R$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta R$ [pb]
LogY=0
# END PLOT

# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*_deta
XLabel=$\Delta \eta$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta \eta$ [pb]
LogY=0
# END PLOT

# BEGIN PLOT /MC_TUTORIAL_TTBAR/.*_dphi
XLabel=$\Delta \phi$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta \phi$ [pb]
LogY=0
# END PLOT

# BEGIN SPECIAL /MC_TUTORIAL_TTBAR/allhad_ allHad
Location=MainPlot
\rput[tr]{0}(1.,1.1){$(N_\ell = 0)$}
# END SPECIAL

# BEGIN SPECIAL /MC_TUTORIAL_TTBAR/onelep_ oneLep
Location=MainPlot
\rput[tr]{0}(1.,1.1){$(N_\ell = 1)$}
# END SPECIAL

# BEGIN SPECIAL /MC_TUTORIAL_TTBAR/twolep_ twoLep
Location=MainPlot
\rput[tr]{0}(1.,1.1){$(N_\ell = 2)$}
# END SPECIAL

# BEGIN SPECIAL /MC_TUTORIAL_TTBAR/anylep_ anyLep
Location=MainPlot
